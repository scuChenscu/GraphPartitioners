...
class Model7Partitioner : public EdgePartitioner {
private:
    size_t cores;
...
//    vector<size_t> reverse_indices;
    ...
    vector<queue<vid_t>> queues;

    // vector<LinkedListPriorityQueue<size_t, vid_t>> priorityQueues;

    vector<LinkedList<vid_t, size_t>> linkedlists;
...
public:
    Model7Partitioner(BaseGraph& baseGraph, const string& input, const string& algorithm,

...
class Model9Partitioner : public EdgePartitioner {
private:
    size_t cores;
...
public:
    Model9Partitioner(BaseGraph& baseGraph, const string& input, const string& algorithm,

...
class OffstreamNWPartitioner : public EdgePartitioner {
private:
...
public:
    OffstreamNWPartitioner(BaseGraph& baseGraph, const string& input, const string& algorithm,
